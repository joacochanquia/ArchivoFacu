...
<div id="main">
    ...
    if(isset($_GET["directory"]))
    {
        ...
        switch($_COOKIE["security_level"])
            ...
            case "0":
                // Se verifica que el directorio al que se quiere acceder sea "documents" o algun directorio interno a este
                $base_dir = realpath("documents");
                $requested_dir = realpath($directory);

                if ($requested_dir !== false && strpos($requested_dir, $base_dir) === 0 && is_dir($requested_dir)) {
                    show_directory($requested_dir);
                } else {
                    //Se muestra un mensaje denegando el acceso

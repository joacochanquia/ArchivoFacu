...
void *Thread_Alta_Prioridad(void *arg) {
...
void *Thread_Baja_Prioridad(void *arg) {
    while (1) {
...
int main() {
    ...
    pthread_create(&thread_principal, NULL, Thread_Alta_Prioridad, NULL);
    ...
    pthread_create(&thread_secundario, NULL, Thread_Baja_Prioridad, NULL);
